...
def y0_from_x0(x1, x2, y1, y2, x0):
  """
  Simulate several guesses and return the best one
  """
  last_hit = 0
  for y_guess in range(1000):
    path = simulate_launch(x0, y_guess, x1, x2, y1, y2)
...
def main():
  ...
  # path = simulate_launch(50, -150, x1, x2, y1, y2)
  # print(path)
  # print(hits_target(path, x1, x2, y1, y2))
  # print(zenith(path))
  # return
  ...
  max_height = -10
  best_path = []
  for x0 in tqdm(range(start_x, x2), ascii=True):
    y0 = y0_from_x0(x1, x2, y1, y2, x0)
  ...
  print(best_path)
  print(max_height)
  plot_path(best_path, x1, x2, y1, y2)
